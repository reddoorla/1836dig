...
<main>
  <header>
    ...
    <p>
      ...
      stable target with predictable a11y characteristics. It is not linked from the
      public site.
    </p>
  </header>
  ...
  <section aria-labelledby="landmarks-heading">
    ...
    <p>
      ...
      <code>aria-labelledby</code> matched to their heading id so screen readers and
      axe both see a clean outline.
    </p>
  </section>
  ...
  <section aria-labelledby="links-heading">
    ...
    <p>
      <a href="/">Back to home</a> — relative link with descriptive visible
      text, so no <code>aria-label</code> override is needed.
    </p>
  </section>
</main>
